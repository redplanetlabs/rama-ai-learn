(ns social-graph-and-fanout.performance-test-support
  "Performance and fault-tolerance private tests for social-graph-and-fanout.
   One module provides both the social graph and post fanout; follows go
   through the SocialGraph protocol methods."
  (:require
